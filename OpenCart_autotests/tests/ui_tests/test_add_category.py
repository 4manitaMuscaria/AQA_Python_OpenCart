...
from OpenCart_autotests.pages.adding_category_page import AddingCategory
from OpenCart_autotests.pages.categories_page import Categories
from OpenCart_autotests.elements.iframe_element import IframeElement
from OpenCart_autotests.elements.file_manager_element import FileManager
...
def test_upload_image(browser, authenticate, test_data):
    AdminAccount(browser).click_catalog()
    AdminAccount(browser).click_categories()
    Categories(browser).add_new()
    AddingCategory(browser).go_to_data_tab()
...
def test_image_select(browser, authenticate, test_data):
    AdminAccount(browser).click_catalog()
    AdminAccount(browser).click_categories()
    Categories(browser).add_new()
    AddingCategory(browser).go_to_data_tab()
...
def test_category_creation(browser, authenticate, test_data, delete_category):
    AdminAccount(browser).click_catalog()
    AdminAccount(browser).click_categories()
    Categories(browser).add_new()
    AddingCategory(browser).close_alert()
